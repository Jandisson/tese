...
\say{\textit{A unifying perspective is emerging of technical debt as the invisible results of past decisions about software that affect its future. The affect can be negative in the form of poorly managed risks but if properly managed can be seen in a positive light to add value in the form of deferred investment opportunities. } }
...
Para verificar a viabilidade de aplicação do framework, Seaman, C et. al., realizaram um estudo onde são investigados os custos necessários para aplicar o arcabouço de gerenciamento
...
Conforme resumido na Tabela \ref{tab:resumo_trabalhos}, foram encontrados sete ótimos trabalhos focados em propor soluções para o problema de estimação dos juros da dívida técnica. 
