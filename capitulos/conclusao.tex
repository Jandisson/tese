...
Podemos identificar algumas dificuldades em realizar a estimação dos juros utilizando essa estratégia. A seguir destacamos algumas delas:
 ...
 \item Pode ser que o projeto tenha sido migrado de outro repositório ou outro sistema de versionamento. Isso precisa ser contornado de alguma forma. Uma alternativa seria verificar o tamanho do \textit{commit} inicial. Preciso resolver os problemas com os  \textit{commits}. Alguns projetos como o vaadin não tem todos os  \textit{commits} na tabela  \textit{commits}. Alguns commits que vieram de \textit{pull requests} por algum motivo não estão lá.
 \end{itemize}
